...
- 이해하기 어려운 챕터였다.
- 다항식 시간 내에 주어진 문제를 풀 수 있다는 것이 보장되는가 하는 문제를 다룬다.
- 약간 고차원적이므로 대충 보아서 잘 모르겠으므로 넘어간다.

---

### 12. 상태공간 트리의 탐색

- 이 파트 역시 이해하기 어려운 챕터였다.
- 최적해를 탐색할 때에 pruning 을 활용하여 빠르게 탐색을 마치는 것을 목표로 한다.
- 이 파트도 약간 고차원적인 듯하여 대충 보았다.

---

### 마치며

알고리즘 기초에 대해 다룬 책을 드디어 마무리했다. 그럼에도 알고리즘의 특성 상 리트코드 등 사이트에서  
주기적으로 문제를 풀면서 익숙해져야지 진짜 알고리즘을 공부한다고 할 수 있을 것이다.  
아무튼 알고리즘 책을 읽으며 어떤 생각을 갖고 문제를 효율적으로 풀어야 할지 감이 잡힐 수 있을 듯 하다.
